...
class TableUtils():
    ...
    def clickOnLinkUsingHoverText(wait, columnName, rowNumber, hoverText):
        """
        Clicks on a link in a table cell identified by its column name, row number,
        and the hover text of the link.
        Parameters:
            wait: Selenium WebDriverWait instance.
    ...
    def clickOnButtonUsingHoverText(wait, columnName, rowNumber, hoverText):
        """
        Clicks on a button in a table cell identified by its column name, row number,
        and the hover text of the button.
        Parameters:
            wait: Selenium WebDriverWait instance.
